export const dashboardStyles = {
  ...
  statCard: "bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow",
  statIcon: "w-12 h-12 rounded-lg flex items-center justify-center mb-4",
  statLabel: "text-sm font-medium text-gray-600 mb-2",
  ...
  // Transactions
  transactionsCard: "bg-white rounded-xl p-6 shadow-sm border border-gray-100",
  transactionsTitle: "text-xl font-bold text-gray-800 mb-6",
  transactionsList: "space-y-4",
  transactionItem: "flex items-center justify-between p-4 bg-gray-50 rounded-lg",
  transactionInfo: "flex-1",
  transactionDesc: "font-medium text-gray-800",
  transactionDateNew: "text-sm text-gray-500 mt-1",
  transactionAmountNew: "text-lg font-semibold",
};
...
export const chartStyles = {
  ...
  chartCard: "bg-white rounded-xl p-6 shadow-sm border border-gray-100",
  chartTitle: "text-xl font-bold text-gray-800 mb-6",
  chartContainer: "space-y-4",
  chartBar: "flex items-center justify-between p-3 bg-gray-50 rounded-lg",
  barLabel: "flex justify-between items-center flex-1",
  barContainer: "w-32 h-2 bg-gray-200 rounded-full ml-4",
  barFill: "h-full bg-teal-500 rounded-full transition-all duration-300",
};
...
export const incomeStyles = {
  ...
  editButton: "text-blue-600 hover:text-blue-900 mr-4",
...
export const modalStyles = {
  ...
  container: "bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl",
  
  // Header
  header: "flex justify-between items-center mb-4",
  title: "text-xl font-bold text-gray-800",
  closeButton: "text-gray-500 hover:text-gray-800 text-2xl",
  
  // Form elements
  form: "space-y-4",
  inputGroup: "space-y-2",
  label: "block text-sm font-medium text-gray-700",
  input: "w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500",
  
  // Button group
  buttonGroup: "flex gap-3 mt-6",
  cancelButton: "flex-1 bg-gray-100 text-gray-800 py-2 rounded-lg font-medium hover:bg-gray-200 transition-colors",
  submitButton: "flex-1 bg-teal-500 text-white py-2 rounded-lg font-medium hover:bg-teal-600 transition-colors",
};
...
export const styles = {
  ...
  transactions: {
    ...
    listContainer: "space-y-4 max-h-[500px] -mx-5 overflow-y-auto pr-2 scrollbar-hide",
